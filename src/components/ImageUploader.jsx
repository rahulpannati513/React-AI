...
const ImageUploader = () => {
  ...
  return (
    <div className="relative bg-white text-black min-h-screen flex justify-center items-center">
      {/* Guidelines Section - Positioned at top left */}
      {showGuidelines && (
        <div
          ref={guidelinesRef}
          className="absolute top-0 left-0 m-4 bg-white text-black p-6 rounded-lg shadow-lg w-[300px] z-50 animate__animated animate__fadeIn"
        >
      ...
      <div className="flex flex-col lg:flex-row w-full max-w-7xl px-4 sm:px-6 md:px-8 py-8 space-y-6 lg:space-y-0 lg:space-x-8">
        ...
        <div className="flex flex-col w-full lg:w-2/5 bg-white bg-opacity-90 p-6 rounded-xl shadow-lg">
          <h1 className="text-3xl sm:text-4xl font-bold text-center mb-6 sm:mb-8 text-black animate__animated animate__fadeIn">
            AI-Driven Image Generation
          </h1>
          <p className="text-lg sm:text-xl text-center mb-6 sm:mb-8 text-black animate__animated animate__fadeIn">
          ...
          <button
            ...
            className="w-full sm:w-auto text-xl bg-indigo-600 hover:bg-indigo-700 text-white py-4 px-8 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-300 transform hover:scale-105"
        ...
        {/* Right Side - Image Display */}
        <div className="flex flex-col w-full lg:w-3/5 bg-white p-6 rounded-xl shadow-lg">
          <h3 className="text-2xl text-center mb-6 text-black">
            Your Generated Image
          </h3>
          {loading && (
            <div className="flex justify-center items-center h-full w-full bg-gray-100 rounded-lg shadow-xl p-6">
          ...
          {imageUrl && !loading && (
            <div className="mt-6 w-full bg-gray-100 p-6 rounded-lg shadow-lg overflow-hidden">
              <img
                src={imageUrl}
                alt="Generated"
